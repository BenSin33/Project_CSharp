...
namespace InteractHub.Api.Migrations
{
    ...
    [Migration("20260513032501_AddUserSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteractHub.Api.Models.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InteractHub.Api.Models.User", b =>
                {
                    ...
                    b.Property<string>("WhoCanComment")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WhoCanSeeFriendsList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WhoCanSendFriendRequest")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InteractHub.Api.Models.ActivityLog", b =>
                {
                    b.HasOne("InteractHub.Api.Models.User", "Admin")
                        .WithMany("ActivityLogs")
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InteractHub.Api.Models.User", "TargetUser")
                        .WithMany()
