<<<<<<<< HEAD:InteractHub/backend/InteractHub.Api/Migrations/20260413090827_InitialCreate.cs
﻿using System;
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StoryContent = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HashTagPost", x => new { x.HashTagsId, x.PostId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HashTagPost_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d", "Admin", "ADMIN" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "b1c2d3e4-f5a6-4b7c-8d9e-1f2a3b4c5d6e", "User", "USER" }
                });
...
>>>>>>>> bb4e037bfec93e613921fbc5e0880b0c3cf5d740:InteractHub/backend/InteractHub.Api/Migrations/20260413092053_InitialCreate.cs
