...
export default function RegisterForm({ onRegister, isLoading = false, serverError }: Props) {
  const {
    register,
    handleSubmit,
    watch,
    ...
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <div>
          ...
          {errors.agreeTerms && (
            <p style={{ fontSize: "12px", color: "#dc2626", marginTop: "4px", fontFamily: "'DM Sans', sans-serif" }}>
