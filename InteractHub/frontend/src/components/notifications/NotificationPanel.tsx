...
export default function NotificationPanel({ isOpen, onClose, notifications, onMarkAllRead }: Props) {
  ...
  useEffect(() => {
    ...
    // Slight delay to prevent immediate close on the bell-button click
  ...
  return (
    // Overlay (semi-transparent left side)
    <div className="fixed inset-0 z-40 bg-black/20">
      {/* Panel — slides in from right */}
      <div
        ref={panelRef}
        className="absolute top-0 right-0 h-full w-[340px] bg-white border-l border-gray-100 flex flex-col"
      >
        {/* Header */}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-[13px] font-medium text-gray-600 overflow-hidden">
                      {n.actor.avatarUrl
