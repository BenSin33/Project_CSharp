...
import { X, Heart, MessageCircle, Share2, Send, Volume2, VolumeX } from "lucide-react";
...
export default function ReelDetailModal({ post, onClose }: Props) {
    ...
    >
      <div className="relative flex w-full max-w-5xl h-[90vh] bg-white rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="flex-1 bg-black flex items-center justify-center min-w-0 relative">
          ...
          <button
            onClick={toggleMute}
            className="absolute bottom-4 right-4 bg-black/50 hover:bg-black/70 text-white rounded-full p-2 transition-colors"
          >
