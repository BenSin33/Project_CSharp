...
\section{Phân tích và Thiết kế hệ thống}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=15cm]{Use_Case_Diagram.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=15cm]{Data_Flow_Diagram.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Auth.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Post.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Like_Noti.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Friendship.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Story.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Admin.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Messaging.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Report_Management.png}
    \caption{Sơ đồ tuần tự quy trình Xử lý Báo cáo}
    \label{fig:seq_report}
    \end{center}
    \end{figure}

    \subsubsection{Quy trình Quản lý Người dùng (Admin User Management Flow)}
    Luồng xử lý dành cho quản trị viên khi quản lý trạng thái tài khoản người dùng (Khóa/Ban):
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_User_Management.png}
    \caption{Sơ đồ tuần tự chức năng Quản lý Người dùng}
    \label{fig:seq_user_mgmt}
    \end{center}
    \end{figure}

    \subsubsection{Quy trình Tìm kiếm và Khám phá (Search \& Discovery Flow)}
    Luồng xử lý khi người dùng tìm kiếm bạn bè hoặc khám phá bài viết qua hashtag:
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=12cm]{Sequence_Search.png}
    \caption{Sơ đồ tuần tự chức năng Tìm kiếm}
...
\section{Hiện thực hóa và kết quả}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Auth_Login.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Auth_Register.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Profile_Main.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Settings_Profile.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Settings_Account.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Settings_Notifications.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Settings_Privacy.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Feed_Main.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Post_Create.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Story_Create.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Story_View.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Profile_Bookmarks.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Explore_Trending.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Explore_Hashtags.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Explore_Reels.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Search_Posts.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Search_Users.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Friends_Requests.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Friends_List.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Friends_Suggestions.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Notifications_Panel.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Chat_Realtime.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Admin_Dashboard.png}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{Admin_Moderation.png}
...
\section{Kiểm thử (Unit Testing)}
    ...
    \subsection{Kiểm thử End-to-End (E2E)}
    Nhóm thực hiện kiểm thử toàn trình từ phía người dùng đến hệ thống quản trị để đảm bảo các tính năng hoạt động trơn tru:
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{E2E_Test_Results.png}
    \caption{Kết quả kiểm thử End-to-End (Admin và User flows)}
    \end{center}
    \end{figure}
...
\section{CI/CD và Triển khai Cloud}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=14cm]{DevOps_CICD.png}
